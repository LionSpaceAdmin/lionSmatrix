...
export default [
  ...
  },
  {
    ...
    rules: {
      ...
      // Security - Extra important for War Machine
      'no-eval': 'error',
      'no-implied-eval': 'error', 
      'no-new-func': 'error',
      
      // Performance - Important for real-time analysis
      ...
      // High security for War Machine (disabled until dependencies are installed)
