# Lions of Zion — Agent Prompts (Claude/Spark‑Env) — Full Pack

**Purpose:** One-stop prompt pack: every page in the App Router tree has a smart English agent prompt (AI‑agent style) ready for handoff to **Claude (Spark‑Env)**. Copy any block to scaffold that page. Prompts are production‑leaning and consistent.

Note on naming: In this document, “Claude (Spark‑Env)” means the Spark agent profile adapted for the Lions of Zion monorepo environment (Next.js 15.5.3, React 18.2, pnpm + Turborepo). Use these prompts exactly as written when working in this repository.
...
- Dev port: 6000 (`pnpm --filter @lionspace/web dev` → http://localhost:6000)
- Node: 20+, pnpm: 8+, Next: 15.5.3, React/DOM: 18.2
- Tailwind: existing code mixes v3/v4. Prefer v3.4‑style utilities until fully migrated.
- Telemetry: keep Sentry/OTel behind flags; stubs only during bring‑up.

Status vs code (checked in this repo)
- Public: `/`, `/opening`, `/daily-brief`, `/impact`, `/about`, `/faq`, `/contact`, `/search` exist. `not-found.tsx` exists. `legal/*` pages do not exist (privacy lives under `/trust/privacy`).
- Auth: `/auth/sign-in`, `/auth/join`, `/auth/onboarding` exist.
- Dashboard: `/dashboard`, `/dashboard/war-machine` exist plus additional dashboard routes.
- Academy: `/academy` and `/academy/[slug]` exist.
- Trust: `/trust/transparency`, `/trust/provenance`, `/trust/dsr`, `/trust/privacy` exist.
- Enterprise: section exists (e.g., `/enterprise/alerts`), but root `/enterprise` page is missing.
...
```json
{
  ...
  "files_to_create": [
    "app/(public)/page.tsx",
    "app/(public)/head.tsx",
    "app/(public)/_content/landing.copy.json"
  ],
  "steps": [
  ...
  "progress_report": "Write app/(public)/_reports/landing.PROGRESS.md summarizing scope, decisions, TODOs."
}
```
...
```json
{
  ...
  "files_to_create": ["app/(public)/opening/page.tsx"],
  "steps": [
  ...
  "progress_report": "app/(public)/_reports/opening.PROGRESS.md"
}
```
...
```json
{
  ...
  "files_to_create": ["app/(public)/daily-brief/page.tsx"],
  "steps": [
  ...
  "progress_report": "app/(public)/_reports/daily-brief.PROGRESS.md"
}
```
...
```json
{
  ...
  "files_to_create": ["app/(public)/archive/page.tsx"],
  "steps": [
  ...
  "progress_report": "app/(public)/_reports/archive.PROGRESS.md"
}
```
...
```json
{
  ...
  "files_to_create": ["app/(public)/archive/[narrativeId]/page.tsx"],
  "steps": [
  ...
  "progress_report": "app/(public)/_reports/narrative-detail.PROGRESS.md"
}
```
...
```json
{
  ...
  "files_to_create": ["app/(public)/playbooks/page.tsx"],
  "steps": [
  ...
  "progress_report": "app/(public)/_reports/playbooks.PROGRESS.md"
}
```
...
```json
{
  ...
  "files_to_create": ["app/(public)/impact/page.tsx"],
  "steps": [
  ...
  "progress_report": "app/(public)/_reports/impact.PROGRESS.md"
}
```
...
```json
{
  ...
  "files_to_create": ["app/(public)/about/page.tsx"],
  "steps": [
  ...
  "progress_report": "app/(public)/_reports/about.PROGRESS.md"
}
```
...
```json
{
  ...
  "context": { "route": "/faq" },
  "files_to_create": ["app/(public)/faq/page.tsx"],
  ...
  "progress_report": "app/(public)/_reports/faq.PROGRESS.md"
}
```
...
```json
{
  ...
  "files_to_create": ["app/(public)/contact/page.tsx"],
  "steps": [
  ...
  "progress_report": "app/(public)/_reports/contact.PROGRESS.md"
}
```
...
```json
{
  ...
  "files_to_create": ["app/(public)/search/page.tsx"],
  ...
  "progress_report": "app/(public)/_reports/search.PROGRESS.md"
}
```
...
```json
{
  ...
  "progress_report": "app/(public)/_reports/legal.PROGRESS.md"
}
```
...
```json
{
  ...
  "context": { "file": "app/not-found.tsx" },
  "files_to_create": ["app/not-found.tsx"],
  ...
  "progress_report": "app/_reports/not-found.PROGRESS.md"
}
```
...
```json
{
  ...
  "files_to_create": ["app/(auth)/sign-in/page.tsx"],
  "steps": [
  ...
  "progress_report": "app/(auth)/_reports/sign-in.PROGRESS.md"
}
```
...
```json
{
  ...
  "files_to_create": ["app/(auth)/join/page.tsx"],
  "steps": [
  ...
  "testing": ["Route test"],
  "progress_report": "app/(auth)/_reports/join.PROGRESS.md"
}
```
...
```json
{
  ...
  "files_to_create": ["app/(auth)/onboarding/page.tsx"],
  "steps": [
  ...
  "progress_report": "app/(auth)/_reports/onboarding.PROGRESS.md"
}
```
...
```json
{
  ...
  "files_to_create": ["app/(dashboard)/page.tsx"],
  "steps": [
  ...
  "progress_report": "app/(dashboard)/_reports/dashboard.PROGRESS.md"
}
```
...
```json
{
  ...
  "files_to_create": ["app/(dashboard)/war-machine/page.tsx"],
  "steps": [
  ...
  "progress_report": "app/(dashboard)/_reports/war-machine.PROGRESS.md"
}
```
...
```json
{
  ...
  "files_to_create": ["app/(dashboard)/tools/image-influence-lab/page.tsx"],
  "steps": [
  ...
  "progress_report": "app/(dashboard)/_reports/image-lab.PROGRESS.md"
}
```
...
```json
{
  ...
  "files_to_create": ["app/(dashboard)/tools/fact-check/page.tsx"],
  "steps": [
  ...
  "progress_report": "app/(dashboard)/_reports/fact-check.PROGRESS.md"
}
```
...
```json
{
  ...
  "files_to_create": ["app/(dashboard)/tools/report-research/page.tsx"],
  "steps": [
  ...
  "progress_report": "app/(dashboard)/_reports/report-research.PROGRESS.md"
}
```
...
```json
{
  ...
  "files_to_create": ["app/(dashboard)/tools/fake-resistance-tracker/page.tsx"],
  "steps": [
  ...
  "progress_report": "app/(dashboard)/_reports/fake-resistance.PROGRESS.md"
}
```
...
```json
{
  ...
  "files_to_create": ["app/(dashboard)/tools/deep-research-daily/page.tsx"],
  "steps": [
  ...
  "progress_report": "app/(dashboard)/_reports/deep-research.PROGRESS.md"
}
```
...
```json
{
  ...
  "files_to_create": ["app/(dashboard)/campaigns/page.tsx"],
  "steps": [
  ...
  "progress_report": "app/(dashboard)/_reports/campaigns.PROGRESS.md"
}
```
...
```json
{
  ...
  "files_to_create": ["app/(academy)/page.tsx"],
  ...
  "testing": ["Search test"],
  "progress_report": "app/(academy)/_reports/academy.PROGRESS.md"
}
```
...
```json
{
  ...
  "files_to_create": ["app/(academy)/[slug]/page.tsx"],
  ...
  "progress_report": "app/(academy)/_reports/article.PROGRESS.md"
}
```
...
```json
{
  ...
  "files_to_create": ["app/(trust)/transparency/page.tsx"],
  "steps": [
  ...
  "progress_report": "app/(trust)/_reports/transparency.PROGRESS.md"
}
```
...
```json
{
  ...
  "files_to_create": ["app/(trust)/provenance/page.tsx"],
  ...
  "progress_report": "app/(trust)/_reports/provenance.PROGRESS.md"
}
```
...
```json
{
  ...
  "files_to_create": ["app/(trust)/dsr/page.tsx"],
  ...
  "testing": ["Validation tests"],
  "progress_report": "app/(trust)/_reports/dsr.PROGRESS.md"
}
```
...
```json
{
  ...
  "files_to_create": ["app/(public)/layout.tsx", "... per group"],
  ...
  "progress_report": "app/_reports/layouts.PROGRESS.md"
}
```
...
```json
{
  ...
  "files_to_create": ["app/layout.tsx", "app/globals.css"],
  "steps": [
  ...
  "progress_report": "app/_reports/root-layout.PROGRESS.md"
}
```
...
```json
{
  ...
  "context": {"file": "app/providers.tsx"},
  "files_to_create": ["app/providers.tsx"],
  "steps": [
  ...
  "testing": ["JSDOM render test; hydration warning free"],
    "progress_report": "app/_reports/providers.PROGRESS.md"
}
```
...
```json
{
  ...
  "context": {"file": "middleware.ts", "locales": ["en","he","es","fr","de","ar"], "defaultLocale": "en"},
  ...
  "progress_report": "app/_reports/middleware.PROGRESS.md"
}
```
...
```json
{
  ...
  "context": {"dir": "lib/i18n"},
  "files_to_create": ["lib/i18n/config.ts", "lib/i18n/index.ts"],
  "steps": [
  ...
  "progress_report": "app/_reports/i18n.PROGRESS.md"
}
```
...
```json
{
  ...
  "context": {"file": "lib/telemetry.ts"},
  "files_to_create": ["lib/telemetry.ts"],
  "steps": [
  ...
  "progress_report": "app/_reports/telemetry.PROGRESS.md"
}
```
...
```json
{
  ...
  "progress_report": "app/_reports/instrumentation.PROGRESS.md"
}
```
...
```json
{
  ...
  "progress_report": "app/_reports/tailwind.PROGRESS.md"
}
```
...
```json
{
  ...
  "progress_report": "app/_reports/ci.PROGRESS.md"
}
```
...
```json
{
  ...
  "progress_report": "app/_reports/readme.PROGRESS.md"
}
```
