    ...
    extend: {
      ...
      colors: {
        ...
        terminal: {
          ...
          text: "rgb(248, 250, 252)", // Increased from rgb(229, 231, 235) for better contrast
          cyan: "rgb(34, 211, 238)", // Changed from rgb(110, 231, 183) to meet 4.5:1 contrast
          gold: "rgb(251, 191, 36)", // Changed from rgb(255, 183, 0) for better contrast
          red: "rgb(239, 68, 68)", // Changed from rgb(212, 63, 63) for better contrast
          border: "rgb(30, 41, 59)",
          muted: "rgb(156, 163, 175)", // Slightly improved contrast
          green: "rgb(34, 197, 94)", // Changed from rgb(110, 231, 183) for better contrast with backgrounds
          success: "rgb(34, 197, 94)", // New success color for positive states
          warning: "rgb(251, 191, 36)", // New warning color
          error: "rgb(239, 68, 68)", // New error color
          info: "rgb(59, 130, 246)", // New info color
        },
        primary: {
      ...
      backgroundImage: {
        ...
        'terminal-gradient': 'linear-gradient(135deg, rgb(110, 231, 183) 0%, rgb(255, 183, 0) 50%, rgb(110, 231, 183) 100%)',
